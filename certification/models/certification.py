...
class Certification(models.Model):
    ...
    expiry_status = fields.Selection([('expired', "Expired"),('available', "Available"),('na', "Not Computed")],'Expiry Status', default="na", store=True, readonly=True, compute='_compute_expiry_status')


    @api.constrains('entity_id')
    def _check_entity_id(self):
        print('kontrol entity id')
